...
const TRANSLATIONS = {
  ...
  en: {
    ...
    'hero.heading1':     'Learn any language from YouTube,',
    'hero.heading2':     'even offline.',
    'hero.tagline':      'LexiPath turns YouTube playlists into structured language learning paths — download videos for offline study, track your progress, and learn Spanish, German, French or any language without internet. No account. No subscription.',
    ...
    'features.paths.title':        'Structured language learning paths',
    'features.paths.desc':         'Organise YouTube videos into named learning paths — ideal for language courses, grammar series, or vocabulary builders. Import from a playlist URL or add videos one by one.',
  ...
  'pt-BR': {
    ...
    'issues.feature.title': '[Funcionalidade] ',
  ...
  it: {
    ...
    'issues.feature.title': '[Funzionalità] ',
  ...
  fr: {
    ...
    'issues.feature.title': '[Fonctionnalité] ',
...
function applyLanguage(lang) {
  ...
  if (bugBtn && t['issues.bug.body']) {
    bugBtn.href = `${BASE}?labels=bug&title=${encodeURIComponent(t['issues.bug.title'] || '[Bug] ')}&body=${encodeURIComponent(t['issues.bug.body'])}`;
  }
  if (featureBtn && t['issues.feature.body']) {
    featureBtn.href = `${BASE}?labels=enhancement&title=${encodeURIComponent(t['issues.feature.title'] || '[Feature] ')}&body=${encodeURIComponent(t['issues.feature.body'])}`;
  }
